...
// This schema validates the form data POSTed by PayU to our subscription callback URL.
// It is identical to the one for regular purchases, as PayU sends a standard payload.
