...
export const postTeacherSupportAttachmentUpload = async (body: InputType, init?: RequestInit): Promise<OutputType> => {
  const validatedInput = schema.parse(body);
  const result = await fetch(`/_api/teacher/support/attachments/upload`, {
    method: "POST",
