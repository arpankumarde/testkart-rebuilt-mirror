...
import Page_155 from "./pages/teacher.live-test.$liveTestId.questions.tsx";
import PageLayout_155 from "./pages/teacher.live-test.$liveTestId.questions.pageLayout.tsx";
import Page_156 from "./pages/teacher.courses.$courseId.lessons.$lessonId.tsx";
import PageLayout_156 from "./pages/teacher.courses.$courseId.lessons.$lessonId.pageLayout.tsx";
import Page_157 from "./pages/teacher.create-test.$testId.test-items.$itemId.preview.tsx";
import PageLayout_157 from "./pages/teacher.create-test.$testId.test-items.$itemId.preview.pageLayout.tsx";
import Page_158 from "./pages/teacher.create-test.$testId.test-items.$itemId.questions.tsx";
import PageLayout_158 from "./pages/teacher.create-test.$testId.test-items.$itemId.questions.pageLayout.tsx";
import Page_159 from "./pages/teacher.create-test.$testId.test-items.$itemId.questions.new.tsx";
import PageLayout_159 from "./pages/teacher.create-test.$testId.test-items.$itemId.questions.new.pageLayout.tsx";
import Page_160 from "./pages/teacher.create-test.$testId.test-items.$itemId.questions.$questionId.edit.tsx";
import PageLayout_160 from "./pages/teacher.create-test.$testId.test-items.$itemId.questions.$questionId.edit.pageLayout.tsx";
...
["./pages/teacher.live-test.$liveTestId.questions.tsx", Page_155],
["./pages/teacher.courses.$courseId.lessons.$lessonId.tsx", Page_156],
["./pages/teacher.create-test.$testId.test-items.$itemId.preview.tsx", Page_157],
["./pages/teacher.create-test.$testId.test-items.$itemId.questions.tsx", Page_158],
["./pages/teacher.create-test.$testId.test-items.$itemId.questions.new.tsx", Page_159],
["./pages/teacher.create-test.$testId.test-items.$itemId.questions.$questionId.edit.tsx", Page_160],
  ]);
...
"./pages/teacher.live-test.$liveTestId.questions.tsx": PageLayout_155,
"./pages/teacher.courses.$courseId.lessons.$lessonId.tsx": PageLayout_156,
"./pages/teacher.create-test.$testId.test-items.$itemId.preview.tsx": PageLayout_157,
"./pages/teacher.create-test.$testId.test-items.$itemId.questions.tsx": PageLayout_158,
"./pages/teacher.create-test.$testId.test-items.$itemId.questions.new.tsx": PageLayout_159,
"./pages/teacher.create-test.$testId.test-items.$itemId.questions.$questionId.edit.tsx": PageLayout_160,
