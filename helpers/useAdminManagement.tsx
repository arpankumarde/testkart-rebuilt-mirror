...
import {
  postAdminAdminsUpdatePermissions,
  InputType as UpdatePermissionsInputType,
} from "../endpoints/admin/admins/update-permissions_POST.schema";
...
export function useUpdateAdminPermissions() {
  ...
  return useMutation({
    mutationFn: (data: UpdatePermissionsInputType) => postAdminAdminsUpdatePermissions(data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ADMINS_QUERY_PREFIX });
    },
  });
