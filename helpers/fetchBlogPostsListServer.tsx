...
import type { InputType, OutputType, PublicPostListItem } from "../endpoints/blog/list_GET.schema";

/**
 * Direct-DB counterpart to endpoints/blog/list_GET.ts, for use ONLY from
 * page prefetch (pages/blog.prefetch.ts and pages/help.prefetch.ts) — see
 ...
 * endpoints/blog/list_GET.ts.
 */
export async function fetchBlogPostsListServer(input: InputType): Promise<OutputType> {
  let query = db
