...
const ACTIONS: Record<string, TeacherAction> = {
  ...
  "bundles/publish": write(bundlesPublish, bundlesPublishSchema, "Submit a bundle for review (it goes live once approved), or unpublish it."),
  ...
  "courses/publish": write(coursesPublish, coursesPublishSchema, "Submit a course for review. It goes live once an admin approves it."),
  ...
  "live-test/publish": write(liveTestPublish, liveTestPublishSchema, "Submit a live test for review by liveTestId. It goes live once an admin approves it."),
  ...
  "live-tests/publish": write(liveTestsPublish, liveTestsPublishSchema, "Submit a live test for review. It goes live once an admin approves it."),
  ...
  "products/bulk": write(productsBulk, productsBulkSchema, "Submit for review, unpublish or archive several study notes at once.", CONFIRM),
  ...
  "products/publish": write(productsPublish, productsPublishSchema, "Submit study notes for review. They go live once an admin approves them."),
  ...
  "tests/publish": write(testsPublish, testsPublishSchema, "Submit a test series for review. It goes live once an admin approves it."),
